...
public class HttpConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http
                ...
                .authorizeHttpRequests(auth->auth.requestMatchers("/api/administrador/**").authenticated())
                .authorizeHttpRequests(auth->auth.requestMatchers("/api/administrador").authenticated())
                .authorizeHttpRequests(auth->auth.requestMatchers("/api/mantenimiento/**").authenticated())
                .authorizeHttpRequests(auth->auth.requestMatchers("/api/mantenimiento").authenticated())
                .authorizeHttpRequests(auth->auth.requestMatchers("/api/tarifa/**").authenticated())
                .authorizeHttpRequests(auth->auth.requestMatchers("/api/tarifa").authenticated())
                .authorizeHttpRequests(auth->auth.requestMatchers("/swagger-ui.html").permitAll())
                .authorizeHttpRequests(auth->auth.requestMatchers("/doc/**").permitAll())
